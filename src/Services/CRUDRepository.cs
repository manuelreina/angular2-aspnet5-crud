...
namespace AngularUniversal.Services
{
    ...
    public class CRUDRepository : ICRUDRepository
    {
        static List<BuiltWith> builtWithList = new List<BuiltWith>
        {
                ...
                new BuiltWith { ID = 4, Name = "Progressive Web Apps", Pending = false },
                new BuiltWith { ID = 5, Name = "Webpack", Pending = false },
                new BuiltWith { ID = 6, Name = "Grunt", Pending = false },
                new BuiltWith { ID = 7, Name = "Bootstrap", Pending = false },
                new BuiltWith { ID = 8, Name = "Angular Material 2", Pending = true }
        };
